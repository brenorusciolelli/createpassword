...
import com.netdeal.crud.createpassword.model.PasswordStatus;
...
public class UserFacade {
	...
	public Position setPosition(User user) {
		...
		Position position = Arrays.stream(Position.values()).filter(p -> p.getValue() == i).findFirst().orElse(null);
